export default function Reason_1(){
    return(
        <div className="w-[100vw] h-[100vh] bg-[url('./images/Reason1.jpeg')] bg-center bg-cover flex justify-center items-center bg-fixed">
            <div className="bg-white flex items-center justify-center w-[50%] h-auto px-[60px] py-[60px]">
                <div className="items-center flex flex-col justify-center text-pretty text-left">
                    ...
                    Путешествие «Пять древних столиц Японии» позволит вам прочувствовать каждый город на пути маршрута, а наш гид все подробно расскажет.</p>
                </div>
            </div>
        </div>
    );
