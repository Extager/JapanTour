...
export default function DS(){
    return(
        <div className="w-[100vw] flex h-[50vh] justify-center items-center">
            <div className="text-center flex mx-5 flex-col items-center w-[360px] text-pretty ">
            ...
            <div className='flex text-center mx-5 flex-col items-center w-[360px] text-pretty'>
